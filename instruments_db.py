...
DDL_STATEMENTS = [
    ...
    "ALTER TABLE instruments ADD COLUMN IF NOT EXISTS price_limit      NUMERIC NOT NULL DEFAULT 0;",
    "ALTER TABLE instruments ALTER COLUMN price_limit TYPE NUMERIC USING price_limit::NUMERIC;",
